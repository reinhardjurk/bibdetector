    ...
    for t_id in tracks_to_process:
        ...
        if len(sightings) >= MIN_CONSECUTIVE_DETECTIONS:
            ...
            if max_consecutive >= MIN_CONSECUTIVE_DETECTIONS and best_num not in globally_completed_bibs:
                ...
                # Optional: Zeichne auch das ROI-Rechteck leicht transparent ins Bild ein
                cv2.rectangle(best_frame, (r_x, r_y), (r_x+r_w, r_y+r_h), (255, 0, 0), 2)
                ...
                print(f"-> Verified Bib {final_number} ({max_consecutive} consecutive hits). Saved!")
